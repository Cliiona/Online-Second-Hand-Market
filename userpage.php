...
if (isset($_SESSION["id"])) {
    ...
    $row = $sth->fetch(PDO::FETCH_ASSOC);
        if($row["userimg"]==NULL)
    {
           $row["userimg"]="./userimgs/default.jpg";
}
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle"
                                       data-toggle="dropdown"><?php echo "hello , " . htmlspecialchars($_SESSION["username"]); ?><strong
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    用戶：<?php echo htmlspecialchars($row["username"]);?>
                                </h3>
                            </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-8 column">
                <ul class="nav nav-tabs" style="background-color: #FFFFFF">
                    ...
                    <li class="active">
<?php 
                                echo"<a href='./userpage.php?id=$id' style='background-color: #a6c9e8'>已發布商品</a>";
?>
                    </li>
