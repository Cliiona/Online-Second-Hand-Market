...
if (isset($_SESSION["id"])) {
    ...
    $sql = "select * from collection where uid=?";
    $sth = $dbh->prepare($sql);
    $sth->execute(array($id));
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-8 column">
                <ul class="nav nav-tabs" style="background-color: #FFFFFF">
                    ...
                    <li class="active">
                        <a href="./user-clc.php"  style="background-color: #a6c9e8">我的收藏</a>
                    </li>
                    <li >
                ...
                <table class="table table-bordered" style="background-color: #FFFFFF">
                    ...
                    while ($row2 = $sth->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <?php
                               $cid=$row2['id'];
                                echo"<td><p style='color:green; font-size:7px'><a href='unlike.php?id=$cid&a='>[取消收藏]</a></td>";
                            ?>
                        </tr>
                    <?php
                    }
